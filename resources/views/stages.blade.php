                        ...
                        <div class="table-responsive">
                            ...
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    ...
                                    var fieldHTML = '<div id="stage" class="js--stage stage-1"><div class="y"><div class="stage_name div-left-input"><div><strong>Stage Name</strong></div><input name="stage_name[]" id="stage_name" type="text" class="form-control"></div><div class="stage1_data div-left-input"><div><strong>Date</strong></div><input type="text" class="js--stage-data form-control" id="stage_date" name="stage_date[]"></div><div class="stage_time div-left-input"><div><strong>Start Time</strong></div><input id="stage_time" class="js--stage-time time ui-timepicker-input form-control" autocomplete="off" name="stage_time[]" type="text"></div><div class="stage_add div-left-input"> <a href="javascript:void(0);" class="remove_button" title="Remove field"><img src="/images/remove-icon.png"/></a> *</div></div></div>';
