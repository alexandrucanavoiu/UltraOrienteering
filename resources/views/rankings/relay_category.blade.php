...
@section('body')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="" class="active">Stage {{ $stage->stage_name }} Categories</a></li>
        </ol>
    </section>
                            ...
                            @foreach($categories as $category)
                                <tr class="stages-list-{{ $category->id }}">
                                    ...
                                    <td class="center no-participants-{{ $category->id }}">
                                        <?php
                                        $participants_count = DB::table('relay_participant_stages')->where('stages_id', '=', $stage->id )->where('relay_categories_id', '=', $category->id )->count();
