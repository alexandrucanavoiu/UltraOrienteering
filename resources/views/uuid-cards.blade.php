...
@section('body')
    ...
    <section class="content">
        ...
        <div class="modal inmodal" id="myModal-UUID-Cards-delete" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script>
        $(function() {
            $('#UUID-cards-list').DataTable({
                ...
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'uuid_name', name: 'uuid_name', className: 'center uuid_name_code'},
                    { data: 'id', name: 'id',
                        "render": function (data, full) {
                            return '<a class="btn-xs btn btn-primary js--edit-uuid-cards" data-id="'+ data +'" data-toggle="modal" data-target="edit-uuid-cards" href="#">Edit</a> <a  href="" data-id="'+data+'" class="delete btn-xs btn btn-danger js--add-value-id" data-toggle="modal" data-target="#myModal-UUID-Cards-delete">Delete</a>';
                        }
                    }
                ],
            });
