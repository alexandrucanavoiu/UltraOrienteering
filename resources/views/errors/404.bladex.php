...
<div class="wrap">
    ...
    <div class="content">
        ...
        <p class="border-404"><span><label>E</label>rror.....</span>You Requested the page that is no longer There.</p>
        <a href="/">Back To DashBoard</a>
        <div class="copy-right">
            <p class="border-404">&#169 Ultra Orienteering Software- <a href="http://www.asociatia.drumetiimontane.ro">Mountain Hiking Association</a></p>
        </div>
    </div>
    <!--End-Cotent------>
</div>
